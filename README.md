# PJG-CppND-Concurrent-Traffic-Simulation

<img src="data/traffic_simulation.gif"/>

Concurrent Traffic Simulation project for the Concurrency course in the [Udacity C++ Nanodegree Program](https://www.udacity.com/course/c-plus-plus-nanodegree--nd213).

This project uses many C++ concurrency programming techniques to develop a simple traffic simulation. The vehicles in the simulation are represented by circles that move along roads and through intersections, all while adhering to traffic light statuses at intersections and following a vehicle queue protocol similar to all-way stops in real life. The project uses a suitable and thread-safe communication protocol (message queue) between vehicles and intersections to complete the simulation. Specific task details that were completed for this project are detailed below.
...
** The following contains the project tasks as they were presented by Udacity. All tasks have been implemented in the code. **
