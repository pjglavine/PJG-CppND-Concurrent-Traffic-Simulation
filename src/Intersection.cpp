...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
  ...
  // If the light is green already, we don't wait, however if it is red, wait until the light changes to green.
...
void Intersection::simulate() // using threads + promises/futures + exceptions
{
	...
	_trafficLight.simulate(); //begin simulation of _trafficLight object.
